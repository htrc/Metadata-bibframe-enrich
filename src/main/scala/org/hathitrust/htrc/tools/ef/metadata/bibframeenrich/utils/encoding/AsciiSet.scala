package org.hathitrust.htrc.tools.ef.metadata.bibframeenrich.utils.encoding
...
trait AsciiSet {
   ...
   */
  private[encoding] def getInternal(i: Int): Boolean
...
private[encoding] final class AsciiChar(i: Int) extends AsciiSet {
  assert(i >= 0 && i < 256)
  private[encoding] override def getInternal(i: Int): Boolean = i == this.i
}

/** A union of two [[AsciiSet]]s. */
private[encoding] final class AsciiUnion(a: AsciiSet, b: AsciiSet) extends AsciiSet {
  require(a != null && b != null)
  private[encoding] override def getInternal(i: Int): Boolean = a.getInternal(i) || b.getInternal(i)
}
